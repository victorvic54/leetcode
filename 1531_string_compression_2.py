    ...
    def getLengthOfOptimalCompression(self, s: str, k: int) -> int:
        ...
        def counter(start, last, last_count, left): #count the cost of compressing from the start
            ...
            if s[start] == last:
                ...
                min_counter = incr + counter(start+1, last, last_count+1, left) # we keep this char for compression
            else:
                ...
                min_counter = min(keep_counter, del_counter)
            
            memo[(start, last, last_count, left)] = min_counter
            return min_counter
